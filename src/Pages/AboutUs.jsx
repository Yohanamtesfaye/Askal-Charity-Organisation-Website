...
const AboutUs = () => {
  return (
    ...
    <div className='p-4 text-center transform transition-transform duration-300 hover:-translate-y-2'>
        ...
        <div className='font-bold text-xl py-2'>Who We Serve</div>
    ...
    <div className='p-4 text-center transform transition-transform duration-300 hover:-translate-y-2'>
        ...
        <div className='font-bold text-xl py-2'>Our Vision</div>
    ...
    <div className='p-4 text-center transform transition-transform duration-300 hover:-translate-y-2'>
        ...
        <div className='font-bold text-xl py-2'>Our Mission</div>
        <div className='font-bold p-2'>
    ...
    <div className='p-4 transform transition-transform duration-300 hover:-translate-y-2'>
        ...
        <div className='font-bold text-xl py-2 text-center'>How to Join Us</div>
        <div className='font-bold p-2'>
    ...
    <div className='p-4 text-center transform transition-transform duration-300 hover:-translate-y-2'>
        ...
        <div className='font-bold text-xl py-2'>Our Resources</div>
        <div className='font-bold p-2'>
    ...
    <div className='p-4 text-center transform transition-transform duration-300 hover:-translate-y-2'>
        ...
        <div className='font-bold text-xl py-2'>Our Location</div>
        <div className='font-bold p-2'>
